...
func TestParseWGPeerReadsTheSecretShape(t *testing.T) {
	sec := map[string]string{
		"private_key":     "cGxhY2Vob2xkZXItcHJpdmF0ZS1rZXktMzJieXRlcw==",
		"address":         "10.20.0.9/32",
		"peer_public_key": "cGxhY2Vob2xkZXItcHVibGljLWtleS0zMmJ5dGVzXw==",
...
func TestParseWGPeerNamesTheMissingFieldOnly(t *testing.T) {
	sec := map[string]string{"private_key": "c2VjcmV0", "address": "10.20.0.9/32"}
